...
class MediaPuntaCreatePdf {
  ...
  MediaPuntaCreatePdf(this._jugador);
...
//Restore the graphics state
  ...
  void capacidadesTecnica(PdfPage page) async {
    ...
    elementoNotas(page,530, 5,'Pases filtrados',_jugador.tec_pasesfiltrados);
    ...
    elementoNotas2(page,545, 250,'Pases largos',_jugador.tec_paseslargos);
    elementoNotas(page,560, 5,'Conducciones',_jugador.tec_salidaconducciones);
    elementoNotas(page,560, 250,'Centros',_jugador.tec_centros);
    page.graphics.drawString(
    ...
    elementoFisico(page, 635, 5, 'Si', _jugador.tec_goleador);
    elementoFisico(page, 635, 125, 'No', _jugador.tec_goleador);
    elementoFisico(
        page, 635, 240, 'Ocacional', _jugador.tec_goleador);
