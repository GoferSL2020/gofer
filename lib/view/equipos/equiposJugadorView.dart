...
class EquipoJugadorView extends StatefulWidget {

  final Pais _pais;
  final bool menu;

  EquipoJugadorView(this._pais,this.menu);
  @override
  _EquipoJugadorViewState createState() => new _EquipoJugadorViewState();
}
