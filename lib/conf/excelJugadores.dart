...
class ExcelJugadores {

  Player _jugadorFiltro;
  ...
  ExcelJugadores(
      this._jugadorFiltro, this._temporada, this._pais, this._categoria);
...
//Adding cell style.
    ...
    columna++; //_altura,
    sheet.getRangeByIndex(1, columna).text = "valor".toUpperCase();
    columna++; //_valor,
    sheet.getRangeByIndex(1, columna).text = "pais Nacimiento".toUpperCase();
    columna++; //_paisNacimiento,
    sheet.getRangeByIndex(1, columna).text = "ccaa".toUpperCase();
    columna++; //_ccaa,
    sheet.getRangeByIndex(1, columna).text = "nacionalidad".toUpperCase();
    columna++; //_nacionalidad,
    sheet.getRangeByIndex(1, columna).text = "contrato".toUpperCase();
    columna++; //_contrato,
    sheet.getRangeByIndex(1, columna).text = "fecha Contrato".toUpperCase();
    columna++; //_fechaContrato,
    sheet.getRangeByIndex(1, columna).text = "veredicto".toUpperCase();
    columna++; //_veredicto,
    sheet.getRangeByIndex(1, columna).text = "prestamo".toUpperCase();
    columna++; //_prestamo,

    sheet.getRangeByIndex(1, columna).text = "J. 1".toUpperCase();
    columna++; //_J. 1,
    sheet.getRangeByIndex(1, columna).text = "J. 2".toUpperCase();
    columna++; //_J. 2,
    sheet.getRangeByIndex(1, columna).text = "J. 3".toUpperCase();
    columna++; //_J. 3,
    sheet.getRangeByIndex(1, columna).text = "J. 4".toUpperCase();
    columna++; //_J. 4,
    sheet.getRangeByIndex(1, columna).text = "J. 5".toUpperCase();
    columna++; //_J. 5,
    sheet.getRangeByIndex(1, columna).text = "J. 6".toUpperCase();
    columna++; //_J. 6,
    sheet.getRangeByIndex(1, columna).text = "J. 7".toUpperCase();
    columna++; //_J. 7,
    sheet.getRangeByIndex(1, columna).text = "J. 8".toUpperCase();
    columna++; //_J. 8,
    sheet.getRangeByIndex(1, columna).text = "J. 9".toUpperCase();
    columna++; //_J. 9,
    sheet.getRangeByIndex(1, columna).text = "J. 10".toUpperCase();
    columna++; //_J. 10,
    sheet.getRangeByIndex(1, columna).text = "J. 11".toUpperCase();
    columna++; //_J. 11,
    sheet.getRangeByIndex(1, columna).text = "J. 12".toUpperCase();
    columna++; //_J. 12,
    sheet.getRangeByIndex(1, columna).text = "J. 13".toUpperCase();
    columna++; //_J. 13,
    sheet.getRangeByIndex(1, columna).text = "J. 14".toUpperCase();
    columna++; //_J. 14,
    sheet.getRangeByIndex(1, columna).text = "J. 15".toUpperCase();
    columna++; //_J. 15,
    sheet.getRangeByIndex(1, columna).text = "J. 16".toUpperCase();
    columna++; //_J. 16,
    sheet.getRangeByIndex(1, columna).text = "J. 17".toUpperCase();
    columna++; //_J. 17,
    sheet.getRangeByIndex(1, columna).text = "J. 18".toUpperCase();
    columna++; //_J. 18,
    sheet.getRangeByIndex(1, columna).text = "J. 19".toUpperCase();
    columna++; //_J. 19,
    sheet.getRangeByIndex(1, columna).text = "J. 20".toUpperCase();
    columna++; //_J. 20,
    sheet.getRangeByIndex(1, columna).text = "J. 21".toUpperCase();
    columna++; //_J. 21,
    sheet.getRangeByIndex(1, columna).text = "J. 22".toUpperCase();
    columna++; //_J. 22,
    sheet.getRangeByIndex(1, columna).text = "J. 23".toUpperCase();
    columna++; //_J. 23,
    sheet.getRangeByIndex(1, columna).text = "J. 24".toUpperCase();
    columna++; //_J. 24,
    sheet.getRangeByIndex(1, columna).text = "J. 25".toUpperCase();
    columna++; //_J. 25,
    sheet.getRangeByIndex(1, columna).text = "J. 26".toUpperCase();
    columna++; //_J. 26,
    sheet.getRangeByIndex(1, columna).text = "J. 27".toUpperCase();
    columna++; //_J. 27,
    sheet.getRangeByIndex(1, columna).text = "J. 28".toUpperCase();
    columna++; //_J. 28,
    sheet.getRangeByIndex(1, columna).text = "J. 29".toUpperCase();
    columna++; //_J. 29,
    sheet.getRangeByIndex(1, columna).text = "J. 30".toUpperCase();
    columna++; //_J. 30,
    sheet.getRangeByIndex(1, columna).text = "J. 31".toUpperCase();
    columna++; //_J. 31,
    sheet.getRangeByIndex(1, columna).text = "J. 32".toUpperCase();
    columna++; //_J. 32,
    sheet.getRangeByIndex(1, columna).text = "J. 33".toUpperCase();
    columna++; //_J. 33,
    sheet.getRangeByIndex(1, columna).text = "J. 34".toUpperCase();
    columna++; //_J. 34,
    sheet.getRangeByIndex(1, columna).text = "J. 35".toUpperCase();
    columna++; //_J. 35,
    sheet.getRangeByIndex(1, columna).text = "J. 36".toUpperCase();
    columna++; //_J. 36,
    sheet.getRangeByIndex(1, columna).text = "J. 37".toUpperCase();
    columna++; //_J. 37,
    sheet.getRangeByIndex(1, columna).text = "J. 38".toUpperCase();
    columna++; //_J. 38,
    sheet.getRangeByIndex(1, columna).text = "J. 39".toUpperCase();
    columna++; //_J. 39,
    sheet.getRangeByIndex(1, columna).text = "J. 40".toUpperCase();
    columna++; //_J. 40,
    sheet.getRangeByIndex(1, columna).text = "J. 41".toUpperCase();
    columna++; //_J. 41,
    sheet.getRangeByIndex(1, columna).text = "J. 42".toUpperCase();
    columna++; //_J. 42,
    sheet.getRangeByIndex(1, columna).cellStyle = styleCabecera2;
    sheet.getRangeByIndex(1, columna).text = "PUNTUACIÓN TOTAL".toUpperCase();
    columna++; //_J. 43,
    sheet.getRangeByIndex(1, columna).cellStyle = styleCabecera2;
    sheet.getRangeByIndex(1, columna).text = "PROMEDIO".toUpperCase();
    columna++; //_J. 43,
    sheet.getRangeByIndex(1, columna).cellStyle = styleCabecera2;
    sheet.getRangeByIndex(1, columna).text =
        "INDICADOR SUBJETIVO PxP".toUpperCase();
    columna++; //_J. 43,
/*sheet.getRangeByIndex(1, columna).text = "J. 44".toUpperCase();columna++;//_J. 44,
    ...
    sheet.getRangeByIndex(1, columna).text = "nivel 1".toUpperCase();
    columna++; //_nivel,
    sheet.getRangeByIndex(1, columna).text = "nivel 2".toUpperCase();
    columna++; //_nivel2,
    sheet.getRangeByIndex(1, columna).text = "nivel 3".toUpperCase();
    columna++; //_nivel3,
    sheet.getRangeByIndex(1, columna).text = "nivel 4".toUpperCase();
    columna++; //_nivel4,
    sheet.getRangeByIndex(1, columna).text = "tipo".toUpperCase();
    columna++; //_observaciones == null ? "".toUpperCase();columna++;//_observaciones,
    sheet.getRangeByIndex(1, columna).text = "descripción".toUpperCase();
    columna++; //_observaciones == null ? "".toUpperCase();columna++;//_observaciones,
    sheet.getRangeByIndex(1, columna).text = "observaciones".toUpperCase();
    columna++; //_observaciones == null ? "".toUpperCase();columna++;//_observaciones,

    sheet.getRangeByIndex(1, columna).text = "ofe niveltecnico".toUpperCase();
    columna++; //_ofe_niveltecnico,
    sheet.getRangeByIndex(1, columna).text = "ofe profundidad".toUpperCase();
    columna++; //_ofe_profundidad,
    sheet.getRangeByIndex(1, columna).text =
        "ofe capacidad de generar buenos centros al area".toUpperCase();
    columna++; //_ofe_capacidaddegenerarbuenoscentrosalarea,
    sheet.getRangeByIndex(1, columna).text =
        "ofe capacidad de asociacion".toUpperCase();
    columna++; //_ofe_capacidaddeasociacion,
    sheet.getRangeByIndex(1, columna).text = "ofe desborde".toUpperCase();
    columna++; //_ofe_desborde,
    sheet.getRangeByIndex(1, columna).text =
        "ofe superioridad por dentro".toUpperCase();
    columna++; //_ofe_superioridadpordentro,
    sheet.getRangeByIndex(1, columna).text = "ofe finalizacion".toUpperCase();
    columna++; //_ofe_finalizacion,
    sheet.getRangeByIndex(1, columna).text =
        "ofe saque de banda longitud".toUpperCase();
    columna++; //_ofe_saquedebanda_longitud,
    sheet.getRangeByIndex(1, columna).text =
        "ofe lanzador de abps".toUpperCase();
    columna++; //_ofe_lanzadordeabps,
    sheet.getRangeByIndex(1, columna).text =
        "ofe salida de balon".toUpperCase();
    columna++; //_ofe_salidadebalon,
    sheet.getRangeByIndex(1, columna).text =
        "ofe pase largo medio".toUpperCase();
    columna++; //_ofe_paselargo_medio,
    sheet.getRangeByIndex(1, columna).text =
        "ofe cambios de orientacion".toUpperCase();
    columna++; //_ofe_cambiosdeorientacion,
    sheet.getRangeByIndex(1, columna).text =
        "ofe bate lineas con pase interior".toUpperCase();
    columna++; //_ofe_batelineasconpaseinterior,
    sheet.getRangeByIndex(1, columna).text =
        "ofe conduccion para dividir".toUpperCase();
    columna++; //_ofe_conduccionparadividir,
    sheet.getRangeByIndex(1, columna).text =
        "ofe primer pase tras recuperacion".toUpperCase();
    columna++; //_ofe_primerpasetrasrecuperacion,
    sheet.getRangeByIndex(1, columna).text =
        "ofe interviene en abps".toUpperCase();
    columna++; //_ofe_intervieneenabps,
    sheet.getRangeByIndex(1, columna).text =
        "ofe velocidad en el juego".toUpperCase();
    columna++; //_ofe_velocidadeneljuego,
    sheet.getRangeByIndex(1, columna).text =
        "ofe incorporacion a zonas de remate".toUpperCase();
    columna++; //_ofe_incorporacionazonasderemate,
    sheet.getRangeByIndex(1, columna).text = "ofe amplitud".toUpperCase();
    columna++; //_ofe_amplitud,
    sheet.getRangeByIndex(1, columna).text =
        "ofe desmarques de apoyo".toUpperCase();
    columna++; //_ofe_desmarquesdeapoyo,
    sheet.getRangeByIndex(1, columna).text =
        "ofe desmarques de ruptura".toUpperCase();
    columna++; //_ofe_desmarquesderuptura,
    sheet.getRangeByIndex(1, columna).text =
        "ofe capacidad de generar buenos centros laterales al area"
            .toUpperCase();
    columna++; //_ofe_capacidaddegenerarbuenoscentroslateralesalarea,
    sheet.getRangeByIndex(1, columna).text = "ofe habilidad 1vs1".toUpperCase();
    columna++; //_ofe_habilidad1vs1,
    sheet.getRangeByIndex(1, columna).text =
        "ofe realizacion del ultimo pase".toUpperCase();
    columna++; //_ofe_realizaciondelultimopase,
    sheet.getRangeByIndex(1, columna).text = "ofe goleador".toUpperCase();
    columna++; //_ofe_goleador,
    sheet.getRangeByIndex(1, columna).text =
        "ofe explotacion de espacios".toUpperCase();
    columna++; //_ofe_explotaciondeespacios,
    sheet.getRangeByIndex(1, columna).text = "ofe duelos aereos".toUpperCase();
    columna++; //_ofe_duelosaereos,
    sheet.getRangeByIndex(1, columna).text =
        "ofe desborde por velocidad".toUpperCase();
    columna++; //_ofe_desbordeporvelocidad,
    sheet.getRangeByIndex(1, columna).text =
        "ofe dominio de 2vs1 pared".toUpperCase();
    columna++; //_ofe_dominiode2vs1_pared,
    sheet.getRangeByIndex(1, columna).text = "ofe ambidextro".toUpperCase();
    columna++; //_ofe_ambidextro,
    sheet.getRangeByIndex(1, columna).text = "ofe juego de cara".toUpperCase();
    columna++; //_ofe_juegodecara,
    sheet.getRangeByIndex(1, columna).text =
        "ofe proteccion de lbalon".toUpperCase();
    columna++; //_ofe_protecciondelbalon,
    sheet.getRangeByIndex(1, columna).text = "ofe caidas a banda".toUpperCase();
    columna++; //_ofe_caidasabanda,
    sheet.getRangeByIndex(1, columna).text =
        "ofe prolongaciones aereas".toUpperCase();
    columna++; //_ofe_prolongacionesaereas,
    sheet.getRangeByIndex(1, columna).text =
        "ofe dominio del area".toUpperCase();
    columna++; //_ofe_dominiodelarea,
    sheet.getRangeByIndex(1, columna).text =
        "ofe llegada a posiciones de remate".toUpperCase();
    columna++; //_ofe_llegadaaposicionesderemate,
    sheet.getRangeByIndex(1, columna).text =
        "ofe juego es espacio reducido".toUpperCase();
    columna++; //_ofe_juegoesespacioreducido,
    sheet.getRangeByIndex(1, columna).text =
        "ofe definidor ante el portero".toUpperCase();
    columna++; //_ofe_definidor_anteelportero,
    sheet.getRangeByIndex(1, columna).text =
        "ofe rematador finalizador".toUpperCase();
    columna++; //_ofe_rematador_finalizador,
    sheet.getRangeByIndex(1, columna).text =
        "ofe capacidad asociativa apoyos a la linea defensiva".toUpperCase();
    columna++; //_ofe_capacidadasociativa_apoyosalalineadefensiva,
    sheet.getRangeByIndex(1, columna).text =
        "ofe desplazamiento en largo".toUpperCase();
    columna++; //_ofe_desplazamientoenlargo,
    sheet.getRangeByIndex(1, columna).text =
        "fis velocidad de reaccion".toUpperCase();
    columna++; //_fis_velocidaddereaccion,
    sheet.getRangeByIndex(1, columna).text =
        "fis velocidad de desplazamiento".toUpperCase();
    columna++; //_fis_velocidaddedesplazamiento,
    sheet.getRangeByIndex(1, columna).text = "fis agilidad".toUpperCase();
    columna++; //_fis_agilidad,
    sheet.getRangeByIndex(1, columna).text = "fis envergadura".toUpperCase();
    columna++; //_fis_envergadura,
    sheet.getRangeByIndex(1, columna).text =
        "fis fuerza potencia".toUpperCase();
    columna++; //_fis_fuerza_potencia,
    sheet.getRangeByIndex(1, columna).text =
        "fis cuerpo a cuerpo".toUpperCase();
    columna++; //_fis_cuerpoacuerpo,
    sheet.getRangeByIndex(1, columna).text =
        "fis capacidad de salto".toUpperCase();
    columna++; //_fis_capacidaddesalto,
    sheet.getRangeByIndex(1, columna).text = "fis explosividad".toUpperCase();
    columna++; //_fis_explosividad,
    sheet.getRangeByIndex(1, columna).text =
        "fis potencia de salto lateral y vertical".toUpperCase();
    columna++; //_fis_potenciadesaltolateralyvertical,
    sheet.getRangeByIndex(1, columna).text =
        "fis resistencia ida y vuelta".toUpperCase();
    columna++; //_fis_resistencia_idayvuelta,
    sheet.getRangeByIndex(1, columna).text =
        "fis cambio de ritmo".toUpperCase();
    columna++; //_fis_cambioderitmo,
    sheet.getRangeByIndex(1, columna).text = "psic liderazgo".toUpperCase();
    columna++; //_psic_liderazgo,
    sheet.getRangeByIndex(1, columna).text = "psic comunicacion".toUpperCase();
    columna++; //_psic_comunicacion,
    sheet.getRangeByIndex(1, columna).text = "psic seguridad".toUpperCase();
    columna++; //_psic_seguridad,
    sheet.getRangeByIndex(1, columna).text =
        "psic toma de decisiones".toUpperCase();
    columna++; //_psic_tomadedecisiones,
    sheet.getRangeByIndex(1, columna).text = "psic agresividad".toUpperCase();
    columna++; //_psic_agresividad,
    sheet.getRangeByIndex(1, columna).text = "psic polivalencia".toUpperCase();
    columna++; //_psic_polivalencia,
    sheet.getRangeByIndex(1, columna).text =
        "psic competitividad".toUpperCase();
    columna++; //_psic_competitividad,
    sheet.getRangeByIndex(1, columna).text =
        "psic agresividad contundencia".toUpperCase();
    columna++; //_psic_agresividad_contundencia,
    sheet.getRangeByIndex(1, columna).text =
        "psic no asume riesgos extremos".toUpperCase();
    columna++; //_psic_noasumeriesgosextremos,
    sheet.getRangeByIndex(1, columna).text =
        "psic entendimiento del juego inteligencia".toUpperCase();
    columna++; //_psic_entendimientodeljuego_inteligencia,
    sheet.getRangeByIndex(1, columna).text = "psic creatividad".toUpperCase();
    columna++; //_psic_creatividad,
    sheet.getRangeByIndex(1, columna).text = "psic confianza".toUpperCase();
    columna++; //_psic_confianza,
    sheet.getRangeByIndex(1, columna).text = "psic compromiso".toUpperCase();
    columna++; //_psic_compromiso,
    sheet.getRangeByIndex(1, columna).text = "psic valentia".toUpperCase();
    columna++; //_psic_valentia,
    sheet.getRangeByIndex(1, columna).text = "psic oportunismo".toUpperCase();
    columna++; //_psic_oportunismo,
    sheet.getRangeByIndex(1, columna).text =
        "def acoso presion sobre el oponente".toUpperCase();
    columna++; //_def_acoso_presionsobreeloponente,
    sheet.getRangeByIndex(1, columna).text =
        "def actituddefensiva".toUpperCase();
    columna++; //_def_actituddefensiva,
    sheet.getRangeByIndex(1, columna).text =
        "def activacion de los mecanismos depresion".toUpperCase();
    columna++; //_def_activaciondelosmecanismosdepresion,
    sheet.getRangeByIndex(1, columna).text = "def anticipacion".toUpperCase();
    columna++; //_def_anticipacion,
    sheet.getRangeByIndex(1, columna).text =
        "def ayudas permanentes al lateral".toUpperCase();
    columna++; //_def_ayudaspermanentesallateral,
    sheet.getRangeByIndex(1, columna).text =
        "def capacidad de marcaje".toUpperCase();
    columna++; //_def_capacidaddemarcaje,
    sheet.getRangeByIndex(1, columna).text =
        "def capacidad para tapar centros".toUpperCase();
    columna++; //_def_capacidadparataparcentros,
    sheet.getRangeByIndex(1, columna).text =
        "def cerrar el lado debil basculaciones".toUpperCase();
    columna++; //_def_cerrarelladodebil_basculaciones,
    sheet.getRangeByIndex(1, columna).text =
        "def cierra lineas de pase".toUpperCase();
    columna++; //_def_cierralineasdepase,
    sheet.getRangeByIndex(1, columna).text =
        "def cobertura de centrales".toUpperCase();
    columna++; //_def_coberturadecentrales,
    sheet.getRangeByIndex(1, columna).text = "def coberturas".toUpperCase();
    columna++; //_def_coberturas,
    sheet.getRangeByIndex(1, columna).text = "def colocacion".toUpperCase();
    columna++; //_def_colocacion,
    sheet.getRangeByIndex(1, columna).text =
        "def comportamiento fuera de zona".toUpperCase();
    columna++; //_def_comportamientofueradezona,
    sheet.getRangeByIndex(1, columna).text =
        "def correcta basculacion".toUpperCase();
    columna++; //_def_correctabasculacion,
    sheet.getRangeByIndex(1, columna).text =
        "def correcta basculacion distancia de intervalos".toUpperCase();
    columna++; //_def_correctabasculacion_distanciadeintervalos,
    sheet.getRangeByIndex(1, columna).text =
        "def correcto perfilamiento".toUpperCase();
    columna++; //_def_correctoperfilamiento,
    sheet.getRangeByIndex(1, columna).text = "def cruces".toUpperCase();
    columna++; //_def_cruces,
    sheet.getRangeByIndex(1, columna).text =
        "def destreza ante centros laterales".toUpperCase();
    columna++; //_def_destrezaantecentroslaterales,
    sheet.getRangeByIndex(1, columna).text =
        "def dificil de superar en el 1vs1".toUpperCase();
    columna++; //_def_dificildesuperarenel1vs1,
    sheet.getRangeByIndex(1, columna).text =
        "def dominio de las zonas de rechace".toUpperCase();
    columna++; //_def_dominiodelaszonasderechace,
    sheet.getRangeByIndex(1, columna).text = "def duelos aereos".toUpperCase();
    columna++; //_def_duelosaereos,
    sheet.getRangeByIndex(1, columna).text =
        "def duelos defensivos".toUpperCase();
    columna++; //_def_duelosdefensivos,
    sheet.getRangeByIndex(1, columna).text =
        "def evita recepciones entre lineas".toUpperCase();
    columna++; //_def_evitarecepcionesentrelineas,
    sheet.getRangeByIndex(1, columna).text =
        "def evita ser desbordado".toUpperCase();
    columna++; //_def_evitaserdesbordado,
    sheet.getRangeByIndex(1, columna).text =
        "def interceptacion de tiro".toUpperCase();
    columna++; //_def_interceptaciondetiro,
    sheet.getRangeByIndex(1, columna).text =
        "def mantener la linea defensiva".toUpperCase();
    columna++; //_def_mantenerlalineadefensiva,
    sheet.getRangeByIndex(1, columna).text =
        "def marcaje proximo a oponente directo".toUpperCase();
    columna++; //_def_marcajeproximoaoponentedirecto,
    sheet.getRangeByIndex(1, columna).text =
        "def ocupa espacios de compañeeros superados".toUpperCase();
    columna++; //_def_ocupaespaciosdecompanerossuperados,
    sheet.getRangeByIndex(1, columna).text = "def perfilamientos".toUpperCase();
    columna++; //_def_perfilamientos,
    sheet.getRangeByIndex(1, columna).text =
        "def permite e lgiro".toUpperCase();
    columna++; //_def_permiteelgiro,
    sheet.getRangeByIndex(1, columna).text =
        "def presion tras perdida".toUpperCase();
    columna++; //_def_presiontrasperdida,
    sheet.getRangeByIndex(1, columna).text =
        "def resolucion ante paredes rivales".toUpperCase();
    columna++; //_def_resolucionanteparedesrivales,
    sheet.getRangeByIndex(1, columna).text =
        "def sabe cuidar su espalda".toUpperCase();
    columna++; //_def_sabecuidarsuespalda,
    sheet.getRangeByIndex(1, columna).text =
        "def vigila y referencia al rival en fase ofensiva".toUpperCase();
    columna++; //_def_vigilayreferenciaalrival_enfaseofensiva,
    sheet.getRangeByIndex(1, columna).text =
        "def vigilancias sobre lateral rival".toUpperCase();
    columna++; //_def_vigilanciassobrelateralrival,
    sheet.getRangeByIndex(1, columna).text = "def blocaje".toUpperCase();
    columna++; //_def_blocaje,
    sheet.getRangeByIndex(1, columna).text =
        "def juego aereo lateral".toUpperCase();
    columna++; //_def_juegoaereolateral,
    sheet.getRangeByIndex(1, columna).text =
        "def juego aereo frontal".toUpperCase();
    columna++; //_def_juegoaereofrontal,
    sheet.getRangeByIndex(1, columna).text =
        "def habilidad en el 1vs1".toUpperCase();
    columna++; //_def_habilidadenel1vs1,
    sheet.getRangeByIndex(1, columna).text = "def despeje".toUpperCase();
    columna++; //_def_despeje,
    sheet.getRangeByIndex(1, columna).text =
        "def anticipacion intuicion".toUpperCase();
    columna++; //_def_anticipacion_intuicion,
    sheet.getRangeByIndex(1, columna).text =
        "def cobertura de linea defensiva".toUpperCase();
    columna++; //_def_coberturadelineadefensiva,
    sheet.getRangeByIndex(1, columna).text = "def abps".toUpperCase();
    columna++; //_def_abps,
    sheet.getRangeByIndex(1, columna).text = "def penaltis".toUpperCase();
...
//Adding a Sheet with name to workbook.
    final Worksheet sheet1 =
        workbook.worksheets.addWithName('DESTACADOS JORN. ${_jugadorFiltro.jornada}');
    ...
    CRUDJugador daoJug = CRUDJugador();
        List<Player> jugadores = await daoJug.fetchJugadoresOnce(_jugadorFiltro,_temporada,_pais,_categoria);
          int columna = 1;
...
//sheet1.getRangeByIndex(fila, columna).value=jug.idjugador;columna++;
            ...
            columna++; //_equipo,
            ponerCeldaValor(sheet1, fila, columna, _temporada.temporada);
            columna++; //_temporada,
            ...
            columna++; //_prestamo,
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_1, jug.estado_jornada_1);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_2, jug.estado_jornada_2);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_3, jug.estado_jornada_3);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_4, jug.estado_jornada_4);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_5, jug.estado_jornada_5);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_6, jug.estado_jornada_6);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_7, jug.estado_jornada_7);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_8, jug.estado_jornada_8);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_9, jug.estado_jornada_9);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_10, jug.estado_jornada_10);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_11, jug.estado_jornada_11);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_12, jug.estado_jornada_12);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_13, jug.estado_jornada_13);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_14, jug.estado_jornada_14);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_15, jug.estado_jornada_15);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_16, jug.estado_jornada_16);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_17, jug.estado_jornada_17);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_18, jug.estado_jornada_18);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_19, jug.estado_jornada_19);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_20, jug.estado_jornada_20);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_21, jug.estado_jornada_21);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_22, jug.estado_jornada_22);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_23, jug.estado_jornada_23);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_24, jug.estado_jornada_24);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_25, jug.estado_jornada_25);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_26, jug.estado_jornada_26);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_27, jug.estado_jornada_27);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_28, jug.estado_jornada_28);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_29, jug.estado_jornada_29);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_30, jug.estado_jornada_30);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_31, jug.estado_jornada_31);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_32, jug.estado_jornada_32);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_33, jug.estado_jornada_33);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_34, jug.estado_jornada_34);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_35, jug.estado_jornada_35);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_36, jug.estado_jornada_36);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_37, jug.estado_jornada_37);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_38, jug.estado_jornada_38);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_39, jug.estado_jornada_39);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_40, jug.estado_jornada_40);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_41, jug.estado_jornada_41);
            columna++;
            ponerCeldaValorPuntuacion(sheet1, fila, columna,
                jug.puntaciones_jornada_42, jug.estado_jornada_42);
            columna++;
            String puntuacionTolal =
                "=SUM(V" + fila.toString() + ":" + "BK" + fila.toString() + ")";
            sheet1.getRangeByIndex(fila, columna).setFormula(puntuacionTolal);
            sheet1.getRangeByIndex(fila, columna).numberFormat = '#,##0.00';
            columna++;
            String promedio = "=AVERAGE(V" +
                fila.toString() +
                ":" +
                "BK" +
                fila.toString() +
            ...
            columna++;
            String indicador =
                "=BL" + fila.toString() + "*BM" + fila.toString() + "";
            print(indicador);
...
/*ponerCeldaValorPuntuacion(sheet1, fila, columna, jug.puntaciones_jornada_43,jug.estado_jornada_43);columna++;
            ...
            ponerCeldaValor(sheet1, fila, columna,
                Player.tipoJugador(jug.posicion, jug.tipo));
            columna++;
            ...
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.ofe_niveltecnico);
            columna++; //_ofe_niveltecnico,
            ...
            columna++; //_ofe_superioridadpordentro,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.ofe_finalizacion);
            columna++; //_ofe_finalizacion,
            ponerCeldaValorCaracter(
            ...
            columna++; //_ofe_lanzadordeabps,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.ofe_salidadebalon);
            columna++; //_ofe_salidadebalon,
            ponerCeldaValorCaracter(
            ...
            columna++; //_ofe_capacidaddegenerarbuenoscentroslateralesalarea,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.ofe_habilidad1vs1);
            columna++; //_ofe_habilidad1vs1,
            ponerCeldaValorCaracter(
            ...
            columna++; //_ofe_explotaciondeespacios,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.ofe_duelosaereos);
            columna++; //_ofe_duelosaereos,
            ponerCeldaValorCaracter(
            ...
            columna++; //_ofe_protecciondelbalon,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.ofe_caidasabanda);
            columna++; //_ofe_caidasabanda,
            ponerCeldaValorCaracter(
            ...
            columna++; //_fis_fuerza_potencia,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.fis_cuerpoacuerpo);
            columna++; //_fis_cuerpoacuerpo,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.fis_capacidaddesalto);
            columna++; //_fis_capacidaddesalto,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.fis_explosividad);
            columna++; //_fis_explosividad,
            ponerCeldaValorCaracter(
            ...
            columna++; //_fis_resistencia_idayvuelta,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.fis_cambioderitmo);
            columna++; //_fis_cambioderitmo,
            ponerCeldaValorCaracter(sheet1, fila, columna, jug.psic_liderazgo);
            columna++; //_psic_liderazgo,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.psic_comunicacion);
            columna++; //_psic_comunicacion,
            ...
            columna++; //_psic_tomadedecisiones,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.psic_agresividad);
            columna++; //_psic_agresividad,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.psic_polivalencia);
            columna++; //_psic_polivalencia,
            ponerCeldaValorCaracter(
            ...
            columna++; //_psic_entendimientodeljuego_inteligencia,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.psic_creatividad);
            columna++; //_psic_creatividad,
            ...
            columna++; //_psic_valentia,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.psic_oportunismo);
            columna++; //_psic_oportunismo,
            ponerCeldaValorCaracter(
            ...
            columna++; //_def_activaciondelosmecanismosdepresion,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.def_anticipacion);
            columna++; //_def_anticipacion,
            ponerCeldaValorCaracter(
            ...
            columna++; //_def_dominiodelaszonasderechace,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.def_duelosaereos);
            columna++; //_def_duelosaereos,
            ponerCeldaValorCaracter(
            ...
            columna++; //_def_perfilamientos,
            ponerCeldaValorCaracter(
                sheet1, fila, columna, jug.def_permiteelgiro);
            columna++; //_def_permiteelgiro,
            ponerCeldaValorCaracter(
...
//print("${jug.equipo}:${jug.jugador}");
    ...
    final File file = File('$path/DESTACADOS JORN.${_jugadorFiltro.jornada}.xlsx');
    await file.writeAsBytes(bytes);
//Launch the file (used open_file package)
    print("ABRRRRRRRRRRRRRRREEEE");
    await open_file.OpenFile.open('$path/DESTACADOS JORN.${_jugadorFiltro.jornada}.xlsx');
//Launch file.
//await FileSaveHelper.saveAndLaunchFile(bytes, 'ExpensesReport.xlsx');
  ...
  ponerCeldaValorNivel(Worksheet sheet1, int fila, int columna, String jug) {
    ...
    if (jug.toUpperCase() == "DISCRETO") {
      sheet1.getRangeByIndex(fila, columna).cellStyle = styleBajo;
    }
    if (jug.toUpperCase() == "N/A") {
      sheet1.getRangeByIndex(fila, columna).cellStyle = styleNAD;
    }
  }
