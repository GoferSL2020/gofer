...
"</p>2. Únicamente los Usuarios expresamente autorizados por ____________________ podrán acceder a la descarga y uso de la APP. Los Usuarios que no dispongan de autorización, no podrán acceder a dicho contenido."
...
"</p>4. Estadísticas anónimas: ___________________ se reserva el derecho a realizar un seguimiento de tu actividad en la Aplicación de y a informar de ello a nuestros proveedores de servicios estadísticos de terceros. Todo ello de forma anónima."
...
"</p>8. Con sujeción a las condiciones establecidas en el apartado anterior, __________________ concede al Usuario una licencia de uso de la APP, no exclusiva, gratuita, para uso personal, circunscrita al territorio nacional y con carácter indefinido. Dicha licencia se concede también en los mismos términos con respecto a las actualizaciones y mejoras que se realizasen en la aplicación. Dichas licencias de uso podrán ser revocadas por ____________________ unilateralmente en cualquier momento, mediante la mera notificación al Usuario."
"</p>9. Corresponde al Usuario, en todo caso, disponer de herramientas adecuadas para la detección y desinfección de programas maliciosos o cualquier otro elemento informático dañino. _________________no se responsabiliza de los daños producidos a equipos informáticos durante el uso de la APP. Igualmente, ________________ no será responsable de los daños producidos a los Usuarios cuando dichos daños tengan su origen en fallos o desconexiones en las redes de telecomunicaciones que interrumpan el servicio."
