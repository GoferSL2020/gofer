        ...
        body: new SingleChildScrollView(
          child: Column(
            ...
            Container(
                ...
                child: TextField(
                  controller: TextEditingController(text: widget._jugador.observaciones_1),
                  ...
                  onChanged: (String value) {
                    widget._jugador.observaciones_1=value;
               ...
               /* Container(
                    padding: EdgeInsets.all(0.0),
                    child: Texto(Colors.blue[900],"Destreza específica (técnica)".toUpperCase()
                        ,12, Colors.white, false)),
                Container(
                    alignment: Alignment.topCenter,
                    padding: EdgeInsets.only(top:0.0, left: 25.0, right: 25.0),
                    child: TextField(
                      controller:TextEditingController(text: widget._jugador.observaciones_2),
                      ...
                      onChanged: (String value) {
                        widget._jugador.observaciones_2=value;
                ...
                Container(
                    padding: EdgeInsets.all(0.0),
                    child: Texto(Colors.blue[900],"Destreza específica (táctica)".toUpperCase()
                        ,12, Colors.white, false)),
                Container(
                    alignment: Alignment.topCenter,
                    padding: EdgeInsets.only(top: 0.0, left: 25.0, right: 25.0),
                    child: TextField(
                      controller: TextEditingController(text: widget._jugador.observaciones_3),
                      maxLines: 6,
                      maxLength: 600,
                      decoration: InputDecoration(
                          fillColor: Colors.white38,
                      ...
                      onChanged: (String value) {
                        widget._jugador.observaciones_3=value;
                ...
                Container(
                    padding: EdgeInsets.all(0.0),
                    child: Texto(Colors.blue[900],"Cualidades psicológicas".toUpperCase()
                        ,12, Colors.white, false)),
                Container(
                    ...
                    padding: EdgeInsets.only(top: 0.0, left: 25.0, right: 25.0),
                    child: TextField(
                      controller: TextEditingController(text: widget._jugador.observaciones_4),
                      maxLines: 6,maxLength: 600,
                      decoration: InputDecoration(
                          fillColor: Colors.white38,
                          filled: true,
                      ...
                      onChanged: (String value) {
                        widget._jugador.observaciones_4=value;
