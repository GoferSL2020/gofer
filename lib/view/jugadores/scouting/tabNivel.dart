...
class TabNivel extends StatefulWidget {
  @override
  TabNivelState createState() => TabNivelState();

  TabNivel(this._jugador, this._padre);
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: TabBar(
              ...
              tabs: [
                new Tab(text: 'Ciclo 1'),
                new Tab(text: 'Ciclo 2'),
                new Tab(text: 'Ciclo 3'),
                new Tab(text: 'Ciclo 4'),
              ]),
        ),
        body: TabBarView(
          children: [
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: RaisedButton(
                                color:
                                    widget._jugador.nivel.toUpperCase() == "N/A"
                                        ? Player.nivelColorNA(
                                            widget._jugador.nivel.toUpperCase())
                                        : Colors.grey,
                                child: Text(
                    ...
                    child: Row(
                        ...
                        children: [
                          SizedBox(
                              width: 105, // specific value
                              child: RaisedButton(
                                color: widget._jugador.nivel3.toUpperCase() ==
                                        "Superlativo".toUpperCase()
                                    ? Player.nivelColorSuperlativo(
                                        widget._jugador.nivel.toUpperCase())
                                    : Colors.grey,
                                ...
                                textColor: Colors.black,
                                splashColor:
                                    widget._jugador.nivel3.toUpperCase() ==
                                            "Superlativo".toUpperCase()
                                        ? Player.nivelColorSuperlativo(
                                            widget._jugador.nivel.toUpperCase())
                                        : Colors.grey,
                    ...
                    child: Row(
                        ...
                        children: [
                          SizedBox(
                              width: 105, // specific value
                              child: RaisedButton(
                                color: widget._jugador.nivel4.toUpperCase() ==
                                        "Superlativo".toUpperCase()
                                    ? Player.nivelColorSuperlativo(
                                        widget._jugador.nivel.toUpperCase())
                                    : Colors.grey,
                                ...
                                textColor: Colors.black,
                                splashColor:
                                    widget._jugador.nivel4.toUpperCase() ==
                                            "Superlativo".toUpperCase()
                                        ? Player.nivelColorSuperlativo(
                                            widget._jugador.nivel.toUpperCase())
                                        : Colors.grey,
