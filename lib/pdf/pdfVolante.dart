...
class VolanteCreatePdf {
  ...
  VolanteCreatePdf(this._jugador);
...
//Restore the graphics state
  ...
  void capacidadesTecnica(PdfPage page) async {
    ...
    elementoNotas2(page,620, 5,'Cierre de líneas de pase',_jugador.tec_cierredelineasdepase);
    elementoNotas2(page,620, 250,'Perdidas de balones',_jugador.tec_perdidasdebalones);
  ...
  void capacidadesTactica(PdfPage page) async {
    ...
    elementoNotas(page,750, 300,'Creativo',_jugador.tac_creativo);//
