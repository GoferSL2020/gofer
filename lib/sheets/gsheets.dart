...
const _credentials2 = r'''
{
  ...
  "client_email": "iadvancedscout@appspot.gserviceaccount.com",
  "client_id": "117737569868203427462",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/iadvancedscout%40appspot.gserviceaccount.com"
}
''';
...
class ProductManager {
  ...
  Future<void> init() async {
    ...
    _productSheet ??= await _spreadsheet.worksheetByTitle('jugadores_IA${BBDDService().getUserScout().temporada}');
    _jornadaSheet??= await _spreadsheet.worksheetByTitle('jornadas_IA${BBDDService().getUserScout().temporada}');
    _jornadaPuntuacionesSheet??= await _spreadsheet.worksheetByTitle('jornadas_puntuaciones_IA${BBDDService().getUserScout().temporada}');
  }
